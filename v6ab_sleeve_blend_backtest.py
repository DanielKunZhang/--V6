...
DEFAULT_REAL_STOCK_PIT_MANIFEST = (
    ROOT
    / "v6_strategy_lab"
    / "configs"
    / "synthetic_history"
    / "20260520_v5_real_stock_pit"
    / "manifest.json"
)
...
V6B_CONFIGS: dict[str, dict[str, Any]] = {
    ...
    "v6b_real_stock_pit_guarded_top3_90": {
        "top_n": 3,
        "min_theme_score": 0.08,
        "risk_weight": 0.90,
        "use_cooldown": True,
        ...
        "expression": "stocks",
        "stock_top_n": 2,
        "pit_manifest": str(DEFAULT_REAL_STOCK_PIT_MANIFEST),
        "pit_theme_map": DEFAULT_CROSS_THEME_PIT_MAP,
    },
    "v6b_real_stock_hybrid_gap_pit_guarded_top3_90": {
        "top_n": 3,
        "min_theme_score": 0.08,
        "risk_weight": 0.90,
        "use_cooldown": True,
