...
- `untracked_files/`: previously untracked research scripts, reports, generated data, and local experiment folders. This folder is intentionally ignored by Git because it is about `1.0G` and mostly contains generated historical outputs.
